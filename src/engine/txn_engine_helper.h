...
class TxnEngineHelper {
 public:
  ...
  static butil::Status Count(RawEnginePtr raw_engine, const pb::store::IsolationLevel &isolation_level,
                             int64_t start_ts, const pb::common::Range &range, const std::set<int64_t> &resolved_locks,
                             int64_t &count);

...
BackupSqlMeta::BackupSqlMeta(ServerInteractionPtr coordinator_interaction)
...
butil::Status BackupSqlMeta::GetSqlMetaRegion() {  // get meta region
  ...
  scan_region_infos_.Add(response.regions().begin(), response.regions().end());

...
BackupSdkData::BackupSdkData(ServerInteractionPtr coordinator_interaction, std::string backupts,
...
void BackupSdkData::SetRegionMap(std::shared_ptr<dingodb::pb::common::RegionMap> region_map) {

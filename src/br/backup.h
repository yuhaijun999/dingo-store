...
class Backup : public std::enable_shared_from_this<Backup> {
 ...
 private:
  ...
  static butil::Status CreateCoordinatorInteraction(const std::vector<std::string>& coordinator_addrs,
                                                    ServerInteractionPtr& coordinator_interaction);
  static butil::Status CreateStoreInteraction(const std::vector<std::string>& store_addrs,
                                              ServerInteractionPtr& store_interaction);
  static butil::Status CreateIndexInteraction(const std::vector<std::string>& index_addrs,
                                              ServerInteractionPtr& index_interaction);
  static butil::Status CreateDocumentInteraction(const std::vector<std::string>& document_addrs,

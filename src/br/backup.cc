...
butil::Status Backup::Run() {
  ...
  std::vector<int64_t> sql_meta_regions;
  {
    ...
    backup_sql_meta_ = std::make_shared<BackupSqlMeta>(coordinator_interaction);
  ...
  // create backup sdk meta
  {
    ...
    backup_sdk_meta_ = std::make_shared<BackupSdkMeta>(coordinator_interaction);
  ...
  // create backup meta
  {
    ...
    backup_meta_ = std::make_shared<BackupMeta>(coordinator_interaction);
  ...
  // create backup data
  {
    ...
    backup_data_ = std::make_shared<BackupData>(coordinator_interaction);
  ...
  // create backup sql data
  {
    ...
    backup_sql_data_ = std::make_shared<BackupSqlData>(coordinator_interaction, backupts_, backuptso_internal_,
                                                       storage_, storage_internal_);
  ...
  // create backup sdk data
  {
    ...
    backup_sdk_data_ = std::make_shared<BackupSdkData>(coordinator_interaction, backupts_, backuptso_internal_,
                                                       storage_, storage_internal_);

...
butil::Status RestoreSqlMeta::Init() {
  ...
  if (store_region_sql_meta_sst_) {
    ...
    DINGO_LOG_IF(INFO, FLAGS_br_log_switch_restore_detail) << "store_region_sql_meta_sst_ = nullptr";
  }
  ...
  if (store_cf_sst_meta_sql_meta_sst_) {
    ...
    DINGO_LOG_IF(INFO, FLAGS_br_log_switch_restore_detail) << "store_cf_sst_meta_sql_meta_sst_ = nullptr";
  }

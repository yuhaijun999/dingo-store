...
class BackupSqlMeta : public std::enable_shared_from_this<BackupSqlMeta> {
 public:
  BackupSqlMeta(ServerInteractionPtr coordinator_interaction);
  ~BackupSqlMeta();
  ...
  butil::Status GetSqlMetaRegion();

 protected:
 private:
  ServerInteractionPtr coordinator_interaction_;
  ::google::protobuf::RepeatedPtrField<dingodb::pb::coordinator::ScanRegionInfo> scan_region_infos_;
};

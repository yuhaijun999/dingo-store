...
class BackupData : public std::enable_shared_from_this<BackupData> {
 public:
  BackupData(ServerInteractionPtr coordinator_interaction, ServerInteractionPtr store_interaction,
             ServerInteractionPtr index_interaction, ServerInteractionPtr document_interaction, std::string backupts,
  ...
  butil::Status Init(std::vector<int64_t>& meta_region_list);

...
#include "dingo-libexpr/rel/rel_runner.h"

using namespace dingodb::expr;
using namespace dingodb::rel;

namespace dingodb {
class RelRunnerTest : public testing::Test {
 protected:
  void SetUp() override {}
...
TEST(RelRunnerTest, GroupedAgg) {
  ...
  Tuple *tuples[]{
      new Tuple{1, "Alice", 10.0f}, new Tuple{2, "Betty", 20.0f}, new Tuple{3, "Cindy", 30.0f},
      new Tuple{4, "Doris", 40.0f}, new Tuple{5, "Emily", 50.0f}, new Tuple{6, "Alice", 60.0f},
      new Tuple{7, "Betty", 70.0f}, new Tuple{8, "Alice", 80.0f}, new Tuple{9, "Cindy", 90.0f},
  };
